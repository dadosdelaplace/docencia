...
2.  [**Filtra**]{.hl-yellow} datos de Madrid (`"M"`), entre el 1 de marzo de 2020 y el 31 de diciembre de 2020, y con sexo `"H"`. Tras ello quédate con las columnas `fecha`, `grupo_edad`, `num_casos` (ese orden). Por último obtén la suma de casos diarios por fecha (sin importar el tramo etario).
