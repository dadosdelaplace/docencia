...
| <img width="250" alt="image" src="https://github.com/user-attachments/assets/70e819d2-1322-4703-af8c-a552159f51b6"> <br> [Time series](https://javieralvarezliebana.es/docencia/time-series)  | The aim of the course is to acquire the theoretical and practical knowledge (R software) necessary to fit time series models that allow to explain the historical evolution of correlated data over time and to predict their future behaviour. | 👨🏻‍🏫 [Slides - diapositivas](https://javieralvarezliebana.es/docencia/time-series/diapos) | [📦 Material](https://javieralvarezliebana.es/docencia/time-series/material) |
