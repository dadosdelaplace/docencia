...
* [**Entrega I (5%)**]{.hl-yellow}: 25 de septiembre (60 minutos).

* [**Entrega II (15%)**]{.hl-yellow}: 9 de octubre (120 minutos).

* [**Entrega III (25%)**]{.hl-yellow}: 30 de octubre (120 minutos).

* [**Entrega IV (30%)**]{.hl-yellow}: 16 de diciembre (120 minutos).
...
| [2](#clase-2) | S2 | 16 sep | Vectores  | [💻](#tu-turno-2-1) [💻](#tu-turno-2-2) [💻](#tu-turno-2-3) |  [🐣](#caso-practico-2-1) [🐣](#caso-practico-2-2)  |  |
| [3](#clase-3) | S2 | 18 sep | Primeras bases de datos | [💻](#tu-turno-3-1) |   [🐣](#caso-practico-3-1)  |  |
| [4](#clase-4) | S3 | 25 sep | Comunicar: apuntes. Entrega I | | [🐣](#caso-practico-4) | [🎯 5%](#entrega-I) |
| [5](#clase-5) | S4 | 30 sep | Estructuras de control | [💻](#tu-turno-5-1) [💻](#tu-turno-5-2) | [🐣](#caso-practico-5-1) | |
| [6](#clase-6) | S4 | 2 oct | Funciones | [💻](#tu-turno-6) | [🐣](#caso-practico-6) | |
| [7](#clase-7) | S5 | 7 oct | Tidy data | [💻](#tu-turno-7) | [🐣](#caso-practico-7) | |
| [8](#clase-8) | S5 | 9 oct | Entrega II |  |  | [🎯 15%](#entrega-II)  |
| [9](#clase-9) | S6 | 14 oct | Tidyverse: filas | [💻](#tu-turno-9-1) [💻](#tu-turno-9-2) | [🐣](#caso-practico-9) |  |
| [10](#clase-10) | S6 | 15 oct | Tidyverse: columnas | [💻](#tu-turno-10-1) [💻](#tu-turno-10-2) | [🐣](#caso-practico-10-1) [🐣](#caso-practico-10-2)  [🐣](#caso-practico-10-3) |  |
| [11](#clase-11) | S6 | 16 oct | Tidyverse: resúmenes | [💻](#tu-turno-11-1) |  [🐣](#caso-practico-11-1) [🐣](#caso-practico-11-2)  |  |
| [12](#clase-12) | S7 | 21 oct | Repaso | | [🐣](#caso-practico-9) [🐣](#caso-practico-10-1) [🐣](#caso-practico-10-2)  [🐣](#caso-practico-10-3)  [🐣](#caso-practico-11-1) [🐣](#caso-practico-11-2)  |  |
| [13](#clase-13) | S7 | 23 oct | Joins e importar | [💻](#tu-turno-13-1) [💻](#tu-turno-13-2) |  [🐣](#caso-practico-13-1) [🐣](#caso-practico-13-2)  |  |
| [14](#clase-14) | S7 | 28 oct | Listas | ... |  ... | |
| [15](#clase-15) | S7 | 30 oct | Entrega III |  |  | [🎯 25%](#entrega-III)  |
...
* [**Diapositivas**]{.hl-yellow}: diapositivas en `Quarto` disponibles y actualizadas en **<https://javieralvarezliebana.es/docencia/R-biostats>**. En el menú de las diapositivas (abajo a la izquierda) tienes una [**opción para descargarlas en pdf**]{.hl-yellow} en `Tools`
...
* [🗃 **Datos**]{.hl-yellow}: datasets que usaremos a lo largo de la asignatura, disponibles en **<https://javieralvarezliebana.es/docencia/R-biostats/material>** y en drive **<https://drive.google.com/drive/folders/1lebT2L2zdrC0TeDzo1c613qavE1umRWw?usp=sharing>**
...
# Clase 3: [primeras bases de datos]{.flow} {#clase-3}

[**Primera base de datos: data.frame y tibble**]{style="color:#444442;"}

* [💻 Ejercicios resueltos: data.frame y tibble](#tu-turno-3-1) 
* [🐣 Workbook/caso práctico II](#caso-practico-3-1)
* [📆 Planificación](#planificacion)
...
## 🐣 Caso práctico II: tibble {#caso-practico-3-1}
...
[**Comunicar: elaborar apuntes, diapositivas, etc. Entrega**]{style="color:#444442;"}

* [🐣 Workbook/caso práctico](#caso-practico-4)

* [🎯 Entrega I (5%)](#entrega-I)
...
# Clase 5: [estructuras control]{.flow} {#clase-5}

[**Estructuras condicionales y bucles**]{style="color:#444442;"}

* [💻 Ejercicios resueltos: estructuras condicionales](#tu-turno-5-1) 

* [💻 Ejercicios resueltos: bucles](#tu-turno-5-2) 

* [🐣 Workbook/caso práctico](#caso-practico-5)
...
## 🐣 Caso práctico {#caso-practico-5-1}


Intenta responder a las preguntas planteadas en el [**workbook**](https://javieralvarezliebana.quarto.pub/control-bucles-if-else-biostats/) donde tendrás que diseñar algunos estudios de simulación haciendo uso de **bucles y estructuras condicionales**




# Clase 6: [funciones]{.flow} {#clase-6}

[**¿Qué es una función? ¿Cómo se definen? Variables locales vs globales**]{style="color:#444442;"}

* [💻 Ejercicios resueltos: funciones](#tu-turno-6) 
...
Intenta responder a las preguntas planteadas en el [**workbook**](https://javieralvarezliebana.quarto.pub/funciones-en-r-biostats/) hasta construirlo.



# Clase 7: [tidydata]{.flow} {#clase-7}

[**Nuestra base de datos: tibble. Tidydata: un multiverso de datos limpios**]{style="color:#444442;"}

* [💻 Ejercicios resueltos: tidy data](#tu-turno-7) 
...
En el paquete `{tidyr}` contamos con el dataset `who2` (dataset de la Organización Mundial de la Salud). Intenta responder a las preguntas planteadas en el [**workbook**](https://javieralvarezliebana.quarto.pub/tidydata-biostats/).
...
# Clase 8: [entrega II]{.flow} {#clase-8}

[**Ponderación: 15%**]{style="color:#444442;"}



# Clase 9: [tidyverse (filas)]{.flow} {#clase-9}

[**Tidyverse: operaciones por filas**]{style="color:#444442;"}

* [💻 Ejercicios resueltos: filter](#tu-turno-9-1) 

* [💻 Ejercicios resueltos: slice, sample, arrange](#tu-turno-9-2) 

* [🐣 Workbook/caso práctico](#caso-practico-9)
...
# Clase 10: [tidyverse (columnas)]{.flow} {#clase-10}

[**Tidyverse: operaciones por columnas**]{style="color:#444442;"}

* [💻 Ejercicios resueltos: select](#tu-turno-10-1) 

* [💻 Ejercicios resueltos: mutate, if_else, case_when](#tu-turno-10-2) 
* [🐣 Workbook/caso práctico I: simulación](#caso-practico-10-1)

* [🐣 Workbook/caso prácticos II-III](#caso-practico-10-2)
...
## 🐣 Caso práctico I: simulación {#caso-practico-10-1}
...
## 🐣 Caso práctico II: Taylor Swift {#caso-practico-10-2}
...
## 🐣 Caso práctico III: señor de los anillos {#caso-practico-10-3}
...
# Clase 11: [tidyverse (resúmenes)]{.flow} {#clase-11}

[**Summarise y group_by(): estadísticas desagregadas.**]{style="color:#444442;"}


* [💻 Ejercicios resueltos](#tu-turno-11-1) 

* [🐣 Workbook/caso práctico I: billboard](#caso-practico-11-1)

* [🐣 Workbook/caso práctico II: fútbol](#caso-practico-11-2)
...
## 🐣 Caso práctico I: billboard {#caso-practico-11-1}
...
## 🐣 Caso práctico II: fútbol  {#caso-practico-11-2}
...
Vamos a hacer un ejercicio con textos. En el [workbook](https://javieralvarezliebana.quarto.pub/dplyr-filas-columnas/#caso-pr%C3%A1ctico-iii-discursos) tienes no solo un caso práctico sino un mini tutorial de cómo trabajar con textos en R haciendo uso del paquete `{stringr}`. En concreto vamos a [**analizar los discursos de Navidad de los jefes de Estado españoles**]{.hl-yellow}
...
Intenta responder a las preguntas planteadas en el [**workbook**](https://javieralvarezliebana.quarto.pub/dplyr-filas-columnas/#caso-pr%C3%A1ctico-iii-discursos)
...
Intenta responder a las preguntas planteadas en el [**workbook**](https://javieralvarezliebana.quarto.pub/dplyr-filas-columnas/#caso-pr%C3%A1ctico-iv-r-base-vs-tidyverse)



# Clase 12: [repaso]{.flow} {#clase-12}

[**En dicha clase se hicieron algunos de los casos prácticos del workbook sin avanzar temario**]{style="color:#444442;"}
...
## 🐣 Caso práctico I: Beatles {#caso-practico-13-1}
...
Intenta responder a las preguntas planteadas en el [**workbook**](https://javieralvarezliebana.quarto.pub/joins-import-export-bio/#caso-pr%C3%A1ctico-i-beatles-y-rolling-stones)


---

## 🐣 Caso práctico II: renta municipios {#caso-practico-13-2}
...
Intenta responder a las preguntas planteadas en el [**workbook**](https://javieralvarezliebana.quarto.pub/joins-import-export-bio/#caso-pr%C3%A1ctico-ii-renta-municipios)
...
# Clase 16: intro a dataviz {#clase-16}
...
Para empezar con algo sencillo [**filtraremos solo los datos de 2007**]{.hl-yellow}
...
* [**Datos (data)**]{.hl-yellow}: conjunto `gapminder_2007`.
...
* [**Geometría (geom)**]{.hl-yellow}: optaremos por **puntos** usando `geom_point()`.  En este caso las **variables deben ser cuantitativas continuas**.
...
```{r}
#| echo: false
ggplot(gapminder_2007, aes(y = gdpPercap, x = pop)) +
  geom_point() 
```
:::
::::
...
Una de las capas más importantes es la [**capa de escalas (personalizar)**]{.hl-yellow} ya que dentro de `aes()` solo le indicamos qué variable mapeamos pero no sus ajustes.

&nbsp;

Por ejemplo, con `scale_color_...()` y `scale_fill_...()` podremos [**personalizar qué colores usar**]{.hl-yellow}. 
...
Con `scale_color_manual()` podemos indicar manualmente una [**paleta**]{.hl-yellow} (<https://htmlcolorcodes.com/>)
...
* [**discos**]{.hl-yellow}: paquete `{taylor}` usando `scale_color_taylor_d(album = ...)` para usar paletas de álbumes de Taylor Swift.
...
Ya vimos como definir paletas de colores pero si te fijas la [**variable que codifica el color era cualitativa o discreta**]{.hl-yellow}, ¿y si la variable que codifica  [**color fuese cuantitativa numérica**]{.hl-yellow}?
...
También podemos crear [**gradientes de color personalizados**]{.hl-yellow} con `scale_color_gradient()`, `scale_fill_gradient()`, `scale_color_gradient2()`, `scale_fill_gradient2()`
...
La **misma idea** que usamos para personalizar colores la podemos aplicar para, por ejemplo, [**personalizar los ejes**]{.hl-yellow}

:::: columns

::: {.column width="47%"}

Vamos a [**personalizar las marcas del eje x**]{.hl-yellow} con `scale_x_continuous(breaks = ...)` para tener marcas cada 10 unidades.
...
En `{ggplot2}` vamos a poder [**personalizar todo el gráfico**]{.hl-yellow} incluido definir nuestro [**propio tema estético**]{.hl-yellow} haciendo uso de las capas `theme_...()`
...
Además de escalas tenemos una [**capa de coordenadas**]{.hl-yellow} con `coord_...` para indicar si queremos un sistema cartesiano, coordenadas polares (`coord_polar()`), si queremos coordenadas iguales (`coord_equal()`) o invertir su rol (`coord_flip()`)
...
Una capa también importante es la [**capa de estadísticas**]{.hl-yellow}
...
* `stat_smooth()`: visualiza un [**ajuste suavizado**]{.hl-yellow} de los datos (reg. lineal, glm, loess, gam, etc). Con `stat_smooth(method = "lm")` una recta de regresión. También con `geom_smooth(method = "lm")`
...
Por último la capa `facet_()`: podemos [**desagregar los gráficos (facetar)**]{.hl-yellow} por grupos, equivalente al `group_by()` en tidyverse.
...
También le podemos pasar dos argumentos (variables) para formar un [**grid de gráficas**]{.hl-yellow} con `facet_grid(var1 ~ var2)`
...
starwars |> 
  ...
  mutate(Human = species == "Human") |> 
  ggplot(aes(x = Human)) +
  geom_bar(aes(fill = sex), alpha = 0.5, position = "dodge2") + 
  scale_fill_colorblind() +
  labs(x = "¿Humanos?", y = "frecuencia absoluta", fill = "sexo", title = "Primer diagrama de barras",
       subtitle = "Sexos: femenino, masculino, hemafrodita, ninguno y ausente",
       caption = "J. Álvarez Liébana")
