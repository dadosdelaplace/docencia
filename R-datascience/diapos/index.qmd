...
* `airquality` del paquete `{datasets}` (ya instalado por defecto): [**medidas diarias (n = 153 observaciones) de la calidad del aire**]{.hl-yellow} en Nueva York, de mayo a septiembre de 1973. Se midieron **6 variables**: niveles de ozono, radiación solar, viento, temperatura, mes y día.
...
https://javieralvarezliebana.quarto.pub/introduccion-a-r-base/)
