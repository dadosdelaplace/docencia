...
## Planificación (parte II) {#planificacion}
...
| [25](#clase-25) | S13 | 2 dic | casos prácticos | | |  |
...
También puede sernos útil para [**acceder a un elemento de la lista**]{.hl-yellow} si le pasas un [**número**]{.hl-yellow} en lugar de una función.
