...
-   [**Evaluación continua**]{.hl-yellow}. A lo largo del curso se han planteado [**3 entregas individuales (15%-25%-35%)**]{.hl-purple}, así como una [**entrega final grupal (25%)**]{.hl-purple} (entre 4 y 6 personas). La nota solo ponderará si supera el 3.5 de media.

. . .

* [**Examen final**]{.hl-yellow}: si el final tiene peso deberás **sacar al menos un 3** para que pondere.

  - [**Entre 3.5 y 5**]{.hl-purple} --> podrás decidir peso del final **entre el 80% y el 100%**
  - [**Entre 5 y 6**]{.hl-purple} --> entre el **60% y el 100%**.
  - [**Entre 6 y 7**]{.hl-purple} --> entre el **40% y el 100%**.
  - [**Entre 7 y 8**]{.hl-purple} --> entre el **20% y el 100%**.
  - [**Más de un 8**]{.hl-purple} --> entre el **0% y el 100%** (podrás **no presentarte al final**).

---

## Planificación entregas

* [**Entrega I (15%)**]{.hl-yellow}: semana ...

* [**Entrega II (25%)**]{.hl-yellow}:

* [**Entrega III (35%)**]{.hl-yellow}:

&nbsp;

* [**Entrega grupal (25%)**]{.hl-yellow}: último día de clase
...
|:------:|:--------:|:--------:|:------:|:------:|:------:|:------:|:------:|:------:|:------:|
| [1](#clase-1) | S1 | 12 sep | Primeros pasos en R | [💻](#tu-turno-1) |  |  | 
| [2](#clase-2) | S1 | 15 sep | Tipos básicos de datos y vectores | [💻](#tu-turno-2-1) [💻](#tu-turno-2-2) |  [🐣](#caso-práctico-2) |  |
| [3](#clase-3) | S2 | 15 sep | Primeras bases de datos | [💻](#tu-turno-3-1) [💻](#tu-turno-3-2) [💻](#tu-turno-3-3) |  [🐣](#caso-práctico-3) |  |
:::
:::
