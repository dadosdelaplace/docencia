...
Podemos también **visualizar las predicciones futuras** para distintos horizontes $h$ (cuando haces `airpass_fit |> forecast(h = ...) |> accuracy(airpass_test)` lo que devuelve es un promedio de su error
...
1. Análisis y visualización descriptiva

2. Determinar si/no tendencia (y de qué tipo)
