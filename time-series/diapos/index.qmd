...
¿Te has fijado en que [**cuando el MA(1) no es explosivo las correlaciones caen a partir de $q$**]{.hl-yellow} (q-correlacionado poblacionalmente aunque a nivel muestral puedan caer algunas todavía fuera de la banda de significación)?
